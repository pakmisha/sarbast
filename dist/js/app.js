...
/* harmony import */ var macy__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! macy */ "./node_modules/macy/dist/macy.js");
/* harmony import */ var macy__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(macy__WEBPACK_IMPORTED_MODULE_4__);
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs, swiper__WEBPACK_IMPORTED_MODULE_0__.Controller, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.Mousewheel, swiper__WEBPACK_IMPORTED_MODULE_0__.Grid]);
...
var inView = __webpack_require__(/*! in-view */ "./node_modules/in-view/dist/in-view.min.js"); // import "./main.js";
...
new Vue({
  ...
  data: function data() {
    return {
      ...
      questions: [{
        ...
        question: "В каком году началось производство Sarbast Original Unfiltered? ",
        isAnswered: null,
        answers: [{
          answer: "2007",
          point: 0
        ...
        question: "В каком международном бельгийской конкурсе участвует Sarbast?",
        isAnswered: null,
        answers: [{
        ...
        question: "У какого саб-бренда семейства Sarbast самое низкое содержание алкоголя?",
        isAnswered: null,
        answers: [{
        ...
        question: "Какую международную награду качества выиграл Sarbast в 2022? ",
        isAnswered: null,
        answers: [{
  ...
  watch: {
    questions: {
      ...
      handler: function handler(value) {
        var answered = this.questions.filter(function (item) {
  ...
  methods: {
    answered: function answered(question, answer) {
...
var APP = {
  ...
  initInputVerify: function initInputVerify() {
    function testJump(x) {
    ...
    if (sessionStorage.getItem("AnnouncementOnce") == "true") {
      ...
      document.querySelector(".modal").classList.add("show"); // document.querySelector("html").classList.remove("no-scroll");
    }

    document.addEventListener("input", function (e) {
      var inputs = _toConsumableArray(document.querySelectorAll(".verify-input"));

      var inputValue = inputs.map(function (n) {
        return n.value;
      }).join("");
      var currentYear = new Date().getFullYear();
      console.log(inputValue);
      var inputValueLenght = inputValue.length;
    ...
    var btnCoockie = document.querySelectorAll(".btn-coockie");

    _toConsumableArray(btnCoockie).forEach(function (item) {
  ...
  initHamburger: function initHamburger() {
    ...
    $hamurger.addEventListener("click", function () {
  ...
  initLinks: function initLinks() {
    ...
    Array.from(document.querySelectorAll(".section")).forEach(function (section) {
      ...
      inView(id).on("enter", function (el) {
  ...
  initSwiper: function initSwiper() {
    _toConsumableArray(document.querySelectorAll(".swiper")).forEach(function ($swiper) {
      var defaultOptions = {
        slidesPerView: 1,
      ...
      var customOptions = $swiper.dataset.options ? JSON.parse($swiper.dataset.options) : {};
      var options = Object.assign(defaultOptions, customOptions);
      var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]($swiper, options);
    ...
    var swiper_thumbs = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper-history-thumbs", {
      slidesPerView: 2,
    ...
    var swiper_product = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper-history", {
      spaceBetween: 10,
      slidesPerView: 1,
      loop: true,
      navigation: {
  ...
  initVideo: function initVideo() {
    _toConsumableArray(document.querySelectorAll(".video__container")).forEach(function ($videoContainer) {
      var video = $videoContainer.querySelector("video");
      var btnContainer = $videoContainer.querySelector(".btn-play");
  ...
  initMacy: function initMacy() {
    var macy = macy__WEBPACK_IMPORTED_MODULE_4___default()({
  ...
  initFlatpicker: function initFlatpicker() {
    _toConsumableArray(document.querySelectorAll(".datepicker")).forEach(function ($picker) {
      var defaultOptions = {
        locale: flatpickr_dist_l10n_ru_js__WEBPACK_IMPORTED_MODULE_2__.Russian
      };
      var customOptions = $picker.dataset.options ? JSON.parse($picker.dataset.options) : {};
      var options = Object.assign(defaultOptions, customOptions);
      (0,flatpickr__WEBPACK_IMPORTED_MODULE_1__["default"])($picker, options);
    });
  },
  initAccordion: function initAccordion() {
    var $accordion = document.querySelectorAll(".faq");

    _toConsumableArray($accordion).forEach(function ($item) {
      _toConsumableArray($item.querySelectorAll(".faq-item-toggle")).forEach(function ($toggle) {
